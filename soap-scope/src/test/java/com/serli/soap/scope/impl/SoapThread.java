...
public class SoapThread extends Thread {
    ...
    public SoapThread(Semaphore s1, Semaphore s2, SOAPRequestListener listener, Service1 service1, Service2 service2) {
    ...
    public void run() {
        try {
            ...
            Logger.getLogger(SoapThread.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
